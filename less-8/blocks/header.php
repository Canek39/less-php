<header class="header">
    <div class="wrap">
        <section class="header__logo">
            <a class="logo__name" href="/less-8/index.php">
                LogoText
    ...
    <div class="wrap">
        <div class="topMenu-flex">
            <ul class="topMenu_link">
                <li><a href="/less-8/index.php">Главная</a></li>
                <li><a href="/less-8/review.php">Отзывы</a></li>
                <li><a href="/less-8/cart.php">Корзина</a></li>
                <?php
                    if($_SESSION['login']){
                        ...
                        if($role):?>
                            <li><a href="/less-8/admin/index.php">Админка</a><li>
                    <?php endif;
                    }
                ?>
            </ul>
            <div class="authorization">
                <?php
                    if($_SESSION['login']){?>
                        Привет, <a href="/less-8/profile.php"> <?= $_SESSION['login'] ?> </a> | <a href="/less-8/quit.php">Выйти</a>
                        <?php }else{ ?>
                            
                    <form action="/less-8/login.php" method="post">
